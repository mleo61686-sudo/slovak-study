...
const UI = {
  ua: {
    ...
    subtitle: "Рейтинг формується за уроки, повторення, диктанти та аудіопрактику.",
    compactSubtitle: "Учні, які вже активно проходять уроки та тренуються у Flunio.",
  ...
  ru: {
    ...
    subtitle: "Рейтинг формируется за уроки, повторение, диктанты и аудиопрактику.",
    compactSubtitle: "Ученики, которые уже активно проходят уроки и тренируются во Flunio.",
  ...
  en: {
    ...
    subtitle: "Ranking is based on lessons, reviews, dictations and audio practice.",
    compactSubtitle: "Learners who are already actively completing lessons and training on Flunio.",
...
function getRankTone(rank: number) {
  ...
  return {
    ring: "border-cyan-300/15 bg-cyan-300/8",
    text: "text-cyan-100",
    glow: "bg-cyan-300/10",
  };
}
...
export default function LeaderboardBlock({
  ...
  return (
    <>
      <section className="flunio-card relative overflow-hidden rounded-3xl p-5 shadow-[0_18px_60px_rgba(0,0,0,0.22)] md:p-7">
