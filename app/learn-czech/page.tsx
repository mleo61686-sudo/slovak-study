...
export const metadata: Metadata = {
  title: "Learn Czech online — course A0–B2 | Flunio",
  description:
    "Learn Czech online with Flunio: A0–B2 lessons, vocabulary, grammar, exercises and audio. Start from scratch and learn step by step.",
  ...
  openGraph: {
    title: "Learn Czech online — course A0–B2 | Flunio",
    description:
      "Czech course with A0–B2 lessons, vocabulary, grammar, exercises and audio — all in one platform.",
    ...
    <main className="mx-auto max-w-4xl space-y-10 px-4 py-10">
      ...
      <section className="space-y-4">
        <h1 className="text-3xl font-extrabold sm:text-4xl">
          Learn Czech online — course A0–B2
        </h1>

        <p className="text-slate-700">
          Flunio is an online platform for learning Czech in a structured way.
        ...
        <p className="text-slate-700">
          This course is useful for people who want to learn Czech for life,
          work, study or everyday communication in the Czech Republic.
        </p>
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border bg-white p-5">
          ...
          <p className="mt-2 text-slate-700">
            New words are not only shown to you — they are reinforced through
        ...
        <div className="rounded-2xl border bg-white p-5">
          ...
          <p className="mt-2 text-slate-700">
            Listen to pronunciation and improve your Czech listening skills.
          </p>
        </div>
      ...
      <section className="rounded-2xl border bg-white p-6 space-y-4">
        <h2 className="text-2xl font-bold">How to start learning Czech online</h2>
      ...
      <section className="rounded-2xl border bg-white p-6 space-y-4">
        ...
        <div className="space-y-3 text-slate-700">
          <p>
            ...
            and practical way to study Czech online without overload.
          </p>

          <p>
            It works well if you want to build everyday vocabulary, understand
            grammar better and gradually become more confident in Czech.
          </p>
        </div>
      </section>
