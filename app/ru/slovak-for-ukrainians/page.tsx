    ...
    <main className="mx-auto max-w-4xl space-y-8 px-4 py-10 text-white">
      ...
      <section className="flunio-card space-y-4 rounded-3xl p-8">
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          ...
          <Link className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-white/80 transition hover:border-cyan-400/35 hover:bg-white/10 hover:text-white" href="/learning/a0-1">
            Начать с A0 →
          </Link>

          <Link className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-white/80 transition hover:border-cyan-400/35 hover:bg-white/10 hover:text-white" href="/dictionary">
            Открыть словарь
          </Link>

          <Link className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-white/80 transition hover:border-cyan-400/35 hover:bg-white/10 hover:text-white" href="/grammar">
      ...
      <section className="flunio-card rounded-3xl p-6 space-y-4">
      ...
      <section className="flunio-card rounded-3xl p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          <Link href="/grammar" className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-white/80 transition hover:border-cyan-400/35 hover:bg-white/10 hover:text-white">
            Открыть грамматику
          </Link>

          <Link href="/dictionary" className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-white/80 transition hover:border-cyan-400/35 hover:bg-white/10 hover:text-white">
            Открыть словарь
          </Link>

          <Link href="/practice" className="rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-white/80 transition hover:border-cyan-400/35 hover:bg-white/10 hover:text-white">
      ...
      <section className="flunio-card rounded-3xl p-6 space-y-4">
        ...
        <div className="space-y-4">
          {FAQ.map((item) => (
            <div key={item.q} className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur">
