...
export const metadata: Metadata = {
  title: "Учить польский язык онлайн с нуля до B2 | Flunio",
  description:
    "Учите польский язык онлайн с нуля: уроки A0–B2, польские слова с переводом, грамматика, аудио произношение и упражнения для ежедневной практики.",
  ...
  openGraph: {
    title: "Учить польский язык онлайн с нуля до B2 | Flunio",
    description:
      "Изучайте польский язык пошагово: короткие уроки, словарь, грамматика, аудио и упражнения.",
...
const FAQ = [
  {
    q: "Можно ли выучить польский язык онлайн с нуля?",
    a: "Да. Flunio подходит для начинающих: можно начать с уровня A0, учить базовые польские слова, слушать произношение и постепенно переходить к более сложным темам.",
  },
  {
    q: "Сколько времени нужно заниматься польским каждый день?",
  ...
  {
    q: "Что входит в курс польского языка?",
  ...
  {
    q: "Сложно ли учить польский язык?",
    a: "Польский может казаться сложным из-за падежей, окончаний, форм глаголов и произношения. Но если учить язык постепенно, с примерами и практикой, он становится намного понятнее.",
  },
  {
    q: "Подходит ли курс для жизни и работы в Польше?",
    a: "Да. Flunio помогает учить практические слова и темы, которые нужны для повседневной жизни, работы, учебы, документов, транспорта и общения в Польше.",
  },
];
...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-4xl space-y-10 px-4 py-10 theme-text">
      ...
      <section className="flunio-card relative overflow-hidden rounded-3xl p-6 sm:p-8">
        ...
        <div className="relative space-y-4">
          <div className="theme-pill inline-flex rounded-full px-3 py-1 text-xs font-semibold">
            Flunio · Польский курс
          </div>

          <h1 className="text-3xl font-extrabold leading-tight tracking-tight theme-text sm:text-4xl">
            Учить польский язык онлайн — структурированный курс от A0 до B2
          </h1>

          <p className="theme-text-muted">
            Flunio помогает учить польский язык онлайн спокойно и по порядку.
            Вместо случайных списков слов, видео и отдельных объяснений вы
            проходите короткие уроки, учите полезную лексику, слушаете
            произношение и постепенно строите базу польского языка.
          </p>

          <p className="theme-text-muted">
            Курс подходит тем, кто начинает польский с нуля, хочет лучше понимать
            повседневную речь или готовится к жизни, работе, учебе и общению в
            Польше.
          </p>
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        {[
          ...
          [
            ...
            "Польское произношение легче запоминать, когда вы регулярно слышите слова. Аудио помогает привыкнуть к звукам и улучшить понимание на слух.",
          ],
          [
      ...
      {[
        {
          title: "Как начать учить польский язык онлайн",
          body: (
            <>
              <p>
              ...
              <ol className="list-decimal space-y-2 pl-5">
                <li>Начните с уровня A0, если вы учите польский с нуля.</li>
        ...
        {
          title: "Польские слова для реальных ситуаций",
          body: (
            <p>
              Хороший курс польского языка должен учить не только отдельные
        ...
        {
          title: "Кому подойдет этот курс польского",
          body: (
            <>
              <p>
                Flunio подойдет тем, кто хочет учить польский язык онлайн
                просто, структурированно и без хаоса.
              </p>
              <p>
                Курс особенно полезен, если польский нужен для жизни в Польше,
                работы, учебы, документов, поездок или общения с людьми.
              </p>
            </>
          ),
        },
      ...
      <section className={`${card} space-y-4 p-6`}>
        <h2 className="text-2xl font-bold theme-text">
          Что сложного в польском языке для начинающих?
        </h2>

        <p className="theme-text-muted">
          Польский — славянский язык с богатой грамматикой, падежами и изменением
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ["Произношение", "В польском есть звуки и буквы ą, ę, ł, ś, ź, ż."],
