...
export const metadata: Metadata = {
  title: "Учить чешский язык онлайн с нуля до B2 | Flunio",
  description:
    "Учите чешский язык онлайн с нуля: уроки A0–B2, чешские слова с переводом, грамматика, аудио произношение и упражнения для ежедневной практики.",
  ...
  openGraph: {
    title: "Учить чешский язык онлайн с нуля до B2 | Flunio",
    description:
      "Изучайте чешский язык пошагово: короткие уроки, словарь, грамматика, аудио и упражнения.",
...
const FAQ = [
  {
    q: "Можно ли выучить чешский язык онлайн с нуля?",
    a: "Да. Flunio подходит для начинающих: можно начать с уровня A0, учить базовые чешские слова, слушать произношение и постепенно переходить к более сложным темам.",
  },
  {
    q: "Сколько времени нужно заниматься чешским каждый день?",
  ...
  {
    q: "Что входит в курс чешского языка?",
  ...
  {
    q: "Сложно ли учить чешский язык?",
    a: "Чешский может казаться сложным из-за падежей, окончаний, форм глаголов и произношения. Но если учить язык постепенно, с примерами и практикой, он становится намного понятнее.",
  },
  {
    q: "Подходит ли курс для жизни и работы в Чехии?",
    a: "Да. Flunio помогает учить практические слова и темы, которые нужны для повседневной жизни, работы, учебы, документов, транспорта и общения в Чехии.",
  },
];
...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-4xl space-y-10 px-4 py-10 theme-text">
      ...
      <section className="flunio-card relative overflow-hidden rounded-3xl p-6 sm:p-8">
        ...
        <div className="relative space-y-4">
          ...
          <h1 className="text-3xl font-extrabold leading-tight tracking-tight theme-text sm:text-4xl">
            Учить чешский язык онлайн — структурированный курс от A0 до B2
          </h1>

          <p className="theme-text-muted">
            Flunio помогает учить чешский язык онлайн спокойно и по порядку.
            Вместо случайных списков слов, видео и отдельных объяснений вы
            проходите короткие уроки, учите полезную лексику, слушаете
            произношение и постепенно строите базу чешского языка.
          </p>

          <p className="theme-text-muted">
            Курс подходит тем, кто начинает чешский с нуля, хочет лучше понимать
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        {[
          ...
          [
            ...
            "Чешское произношение легче запоминать, когда вы регулярно слышите слова. Аудио помогает привыкнуть к звукам и улучшить понимание на слух.",
          ],
          [
      ...
      {[
        {
          title: "Как начать учить чешский язык онлайн",
          body: (
            <>
              <p>
              ...
              <ol className="list-decimal space-y-2 pl-5">
                <li>Начните с уровня A0, если вы учите чешский с нуля.</li>
        ...
        {
          title: "Чешские слова для реальных ситуаций",
          body: (
            <p>
              Хороший курс чешского языка должен учить не только отдельные
        ...
        {
          title: "Кому подойдет этот курс чешского",
          body: (
            <>
              <p>
                Flunio подойдет тем, кто хочет учить чешский язык онлайн
                просто, структурированно и без хаоса.
              </p>
              <p>
                Курс особенно полезен, если чешский нужен для жизни в Чехии,
      ...
      <section className={`${card} space-y-4 p-6`}>
        <h2 className="text-2xl font-bold theme-text">
          Что сложного в чешском языке для начинающих?
        </h2>

        <p className="theme-text-muted">
          Чешский — славянский язык с богатой грамматикой, падежами и изменением
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ["Произношение", "В чешском есть звуки и буквы č, š, ž, ř, ě."],
