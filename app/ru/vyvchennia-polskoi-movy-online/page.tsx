...
export const metadata: Metadata = {
  title: "Изучение польского языка онлайн с нуля A0–B2 | Flunio",
  description:
    "Изучай польский язык онлайн во Flunio: короткие уроки A0–B2, словарь, грамматика, упражнения, озвучка и прогресс для ежедневного обучения.",

  alternates: {
    canonical: `${SITE_URL}/ru/vyvchennia-polskoi-movy-online`,
    languages: {
  ...
  openGraph: {
    title: "Изучение польского языка онлайн с нуля A0–B2 | Flunio",
    description:
      "Польский язык онлайн: уроки, словарь, грамматика, упражнения, озвучка и прогресс в одном месте.",
    url: `${SITE_URL}/ru/vyvchennia-polskoi-movy-online`,
    siteName: "Flunio",
    type: "website",
  },
...
const FAQ = [
  {
    q: "Можно ли изучать польский онлайн с нуля?",
  ...
  {
    q: "Подходит ли Flunio для жизни или работы в Польше?",
    ...
    <main className="mx-auto max-w-4xl space-y-8 px-4 py-10 theme-text">
      ...
      <section className={`${card} space-y-4 p-8`}>
        <h1 className="text-3xl font-extrabold theme-text sm:text-4xl">
          Изучение польского языка онлайн — курс с нуля до B2
        </h1>

        <p className="theme-text-muted">
          Flunio помогает изучать польский язык онлайн системно и без хаоса.
        ...
        <p className="theme-text-muted">
          ...
          общение или изучает польский для жизни, работы, учёбы или документов в
          Польше. Начни с A0 и двигайся дальше к A1, A2, B1 и B2 в своём темпе.
        </p>
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          ...
          <Link href="/vyvchennia-polskoi-movy-online" className={secondaryButton}>
            Українська версія →
          </Link>
        </div>
      </section>
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        ...
        <div className={`${card} p-5`}>
          ...
          <p className="mt-2 theme-text-muted">
            Польский важно не только читать, но и слышать. Озвучка помогает
      ...
      <section className={`${card} space-y-4 p-6`}>
        <h2 className="text-2xl font-bold theme-text">
          Как начать изучать польский язык онлайн
        </h2>
        ...
        <ol className="list-decimal space-y-2 pl-5 theme-text-muted">
          <li>Начни с A0, если изучаешь польский с нуля.</li>
      ...
      <section className={`${card} space-y-4 p-6`}>
        <h2 className="text-2xl font-bold theme-text">
          Что самое сложное в польском для начинающих?
        </h2>

        <p className="theme-text-muted">
          Польский язык имеет много общего с другими славянскими языками, но всё
          равно требует системного подхода. Чаще всего сложность вызывают
          произношение, буквосочетания, падежи, окончания слов и формы глаголов.
          Это нормально: такие вещи лучше усваиваются постепенно, через примеры
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className={`${softCard} p-4`}>
            ...
            <p className="mt-2 text-sm theme-text-muted">
              В польском есть характерные звуки и буквосочетания sz, cz, rz, ż,
              ś, ć, ł. Озвучка помогает быстрее привыкнуть к произношению.
            </p>
          </div>
      ...
      <section className={`${card} space-y-4 p-6`}>
        <h2 className="text-2xl font-bold theme-text">
          Польская лексика для реальных ситуаций
        </h2>

        <p className="theme-text-muted">
          Хорошее обучение польскому должно давать не только отдельные слова, но
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className={`${softCard} p-4`}>
            <h3 className="font-semibold theme-text">Повседневный польский</h3>
            <p className="mt-2 theme-text-muted">
      ...
      <section className={`${card} space-y-4 p-6`}>
        ...
        <p className="theme-text-muted">
          Такой подход особенно полезен для польского, потому что падежи,
      ...
      <section className={`${card} space-y-4 p-6`}>
        <h2 className="text-2xl font-bold theme-text">
          Кому подойдёт обучение польскому во Flunio
        </h2>

        <div className="space-y-3 theme-text-muted">
          <p>
            Flunio подойдёт тем, кто хочет изучать польский онлайн в простом,
          ...
          <p>
            Курс также полезен, если польский нужен для повседневной жизни,
