...
export const metadata: Metadata = {
  title: "Изучение польского языка онлайн — курс A0–B2 | Flunio",
  description:
    "Онлайн курс польского языка во Flunio: уровни A0–B2, уроки, упражнения, словарь, грамматика и озвучка. Начни изучать польский системно и удобно.",
  ...
  openGraph: {
    title: "Изучение польского языка онлайн — курс A0–B2 | Flunio",
    description:
      "Уроки польского A0–B2, словарь, грамматика, упражнения и озвучка — всё в одной платформе.",
...
const FAQ = [
  ...
  {
    q: "Подходит ли этот курс для жизни и работы в Польше?",
    ...
    <main className="mx-auto max-w-4xl space-y-10 px-4 py-10">
      ...
      <section className="space-y-4">
        <h1 className="text-3xl font-extrabold sm:text-4xl">
          Изучение польского языка онлайн — курс A0–B2
        </h1>

        <p className="text-slate-700">
          Flunio — это онлайн-платформа для системного изучения польского языка.
          Здесь можно проходить уроки по уровням, закреплять слова в упражнениях,
          пользоваться словарём и параллельно закрывать грамматику.
        </p>

        <p className="text-slate-700">
          Платформа подойдёт тем, кто хочет учить польский для жизни, работы,
          учёбы или повседневного общения в Польше.
        </p>
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          ...
          <Link href="/vyvchennia-polskoi-movy-online" className="rounded-xl border px-4 py-2">
            Українська версія →
          </Link>
        </div>
      </section>
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border bg-white p-5">
          ...
          <p className="mt-2 text-slate-700">
            Уроки построены по уровням A0–B2, чтобы ты двигался постепенно и без хаоса.
          </p>
        </div>
        ...
        <div className="rounded-2xl border bg-white p-5">
          ...
          <p className="mt-2 text-slate-700">
            Новые слова не просто читаются, а сразу закрепляются в упражнениях и повторении.
          </p>
        </div>
        ...
        <div className="rounded-2xl border bg-white p-5">
          ...
          <p className="mt-2 text-slate-700">
            Слушай произношение и тренируй восприятие польского языка на слух.
          </p>
        </div>
        ...
        <div className="rounded-2xl border bg-white p-5">
          ...
          <p className="mt-2 text-slate-700">
            На платформе есть словарь с поиском и страницы грамматики с примерами и объяснениями.
          </p>
        </div>
      </section>

      <section className="rounded-2xl border bg-white p-6 space-y-4">
        <h2 className="text-2xl font-bold">Как начать изучать польский онлайн</h2>

        <ol className="list-decimal space-y-2 pl-5 text-slate-700">
          <li>Начни с уровня A0, если учишь польский с нуля.</li>
      ...
      <section className="rounded-2xl border bg-white p-6 space-y-4">
        <h2 className="text-2xl font-bold">Кому подойдёт онлайн курс польского</h2>

        <div className="space-y-3 text-slate-700">
          <p>
            Flunio подойдёт тем, кто хочет изучать польский в удобном формате без
