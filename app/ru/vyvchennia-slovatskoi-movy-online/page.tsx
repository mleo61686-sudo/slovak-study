...
export const metadata: Metadata = {
    title: "Изучение словацкого языка онлайн — курс A0–B2, упражнения, словарь | Slovak Study",
    description:
        ...
        <main className="mx-auto max-w-4xl px-4 py-10 space-y-10">
            ...
            <section className="space-y-3">
                ...
                <p className="text-slate-700">
                    Slovak Study — онлайн-тренажёр для украинцев: короткие уроки, озвучка, упражнения, словарь и грамматика.
                    Подойдёт для жизни и работы в Словакии: учишься системно и видишь прогресс.
                </p>
