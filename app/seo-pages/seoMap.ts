...
export const SEO_MAP: SeoMapItem[] = [
  ...
  },
  {
    ...
    course: "cs",
    intentType: "grammar",
    mainKeyword: "learn Czech grammar online",
    intent: "English SEO page for learning Czech grammar online: cases, verbs and word order",
    status: "keep",
    inSitemap: true,
  },
  {
  ...
  },
  {
    ...
    course: "pl",
    intentType: "vocabulary",
    mainKeyword: "vocabulary in Polish",
    intent: "English SEO page for beginner vocabulary in Polish by topic",
    status: "keep",
    inSitemap: true,
  },
  {
