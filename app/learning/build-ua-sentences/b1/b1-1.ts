...
export const B1_BUILD_UA_SENTENCES_1: BuildUaSentenceDict = {
  ...
  [phraseKey("dochádzka", "b1-1")]: {
    ...
    uaTokens: ["Відвідуваність/табель", "ми", "відмічаємо", "в", "додатку", "."],
    ruTokens: ["Посещаемость/табель", "мы", "отмечаем", "в", "приложении", "."],
  ...
  [phraseKey("benefit", "b1-1")]: {
    ...
    uaTokens: ["Як", "бонус", "у", "нас", "є", "харчові", "та", "мультиспорт-карта", "."],
  ...
  [phraseKey("cestujúci", "b1-3")]: {
    ...
    uaTokens: ["Пасажири", "повинні", "мати", "квиток", "готовий", "до", "перевірки", "."],
