// app/learning/phrases/b1-3.ts
import type { Phrase } from "./b1";
import { phraseKey } from "./phraseKey";

export const B1_PHRASES_3: Record<string, Phrase> = {
  // =========================
  // LESSON 21 — Krajiny
  // =========================
  ...
  [phraseKey("Nemecko", "Німеччина", "b1-21")]: {
  ...
  [phraseKey("Rakúsko", "Австрія", "b1-21")]: {
  ...
  [phraseKey("Francúzsko", "Франція", "b1-21")]: {
  ...
  [phraseKey("Taliansko", "Італія", "b1-21")]: {
  ...
  [phraseKey("Španielsko", "Іспанія", "b1-21")]: {
  ...
  [phraseKey("televízia", "телебачення", "b1-22")]: {
  ...
  [phraseKey("vysielanie", "трансляція", "b1-22")]: {
  ...
  [phraseKey("titulok", "заголовок", "b1-22")]: {
  ...
  [phraseKey("uveriť", "повірити", "b1-22")]: {
  ...
  [phraseKey("verejná myšlienka", "громадська думка", "b1-22")]: {
  ...
  [phraseKey("sledovateľ", "підписник", "b1-23")]: {
  ...
  [phraseKey("komentovať", "коментувати", "b1-23")]: {
  ...
  [phraseKey("označiť", "позначити / тегнути", "b1-23")]: {
  ...
  [phraseKey("zdieľať", "поширювати", "b1-23")]: {
  ...
  [phraseKey("správa", "повідомлення", "b1-23")]: {
  ...
  [phraseKey("upozornenie", "сповіщення", "b1-23")]: {
  ...
  // =========================
  [phraseKey("pozvanie", "запрошення", "b1-24")]: {
  ...
  [phraseKey("hostiteľ", "господар", "b1-24")]: {
  ...
  [phraseKey("pohostenie", "частування", "b1-24")]: {
  ...
  [phraseKey("priniesť darček", "принести подарунок", "b1-24")]: {
  ...
  [phraseKey("slušnosť", "ввічливість", "b1-24")]: {
  ...
  [phraseKey("privítať", "привітати (зустріти)", "b1-24")]: {
  ...
  [phraseKey("ponúknuť", "запропонувати (частування)", "b1-24")]: {
  ...
  [phraseKey("poďakovať sa", "подякувати", "b1-24")]: {
  ...
  [phraseKey("rozlúčiť sa", "попрощатися", "b1-24")]: {
  ...
  // =========================
  [phraseKey("sklamanie", "розчарування", "b1-25")]: {
  ...
  [phraseKey("hrdosť", "гордість", "b1-25")]: {
  ...
  [phraseKey("úľava", "полегшення", "b1-25")]: {
  ...
  [phraseKey("neistota", "невпевненість", "b1-25")]: {
  ...
  [phraseKey("frustrácia", "фрустрація", "b1-25")]: {
  ...
  [phraseKey("pochybnosť", "сумнів", "b1-25")]: {
  ...
  [phraseKey("spokojnosť", "задоволення", "b1-25")]: {
  ...
  [phraseKey("bezmocnosť", "безсилля", "b1-25")]: {
  ...
  [phraseKey("vyčerpanie", "виснаження", "b1-25")]: {
  ...
  // =========================
  [phraseKey("porozumenie", "розуміння", "b1-26")]: {
  ...
  [phraseKey("predsudok", "упередження", "b1-26")]: {
  ...
  [phraseKey("rovnosť", "рівність", "b1-26")]: {
  ...
  [phraseKey("tolerancia", "толерантність", "b1-26")]: {
  ...
  [phraseKey("diskriminácia", "дискримінація", "b1-26")]: {
  ...
  [phraseKey("spolužitie", "співжиття", "b1-26")]: {
  ...
  // =========================
  [phraseKey("bezpečnosť práce", "охорона праці", "b1-27")]: {
  ...
  [phraseKey("ochranné pomôcky", "засоби захисту", "b1-27")]: {
  ...
  [phraseKey("školenie", "інструктаж", "b1-27")]: {
  ...
  [phraseKey("dodržiavať", "дотримуватися", "b1-27")]: {
  ...
  [phraseKey("pracovný úraz", "виробнича травма", "b1-27")]: {
  ...
  [phraseKey("bezpečnostné pravidlá", "правила безпеки", "b1-27")]: {
  ...
  [phraseKey("upozornenie", "попередження", "b1-27")]: {
  ...
  // =========================
  [phraseKey("najprv", "спочатку", "b1-28")]: {
  ...
  [phraseKey("medzitým", "тим часом", "b1-28")]: {
  ...
  [phraseKey("nakoniec", "врешті", "b1-28")]: {
  ...
  [phraseKey("napokon", "зрештою", "b1-28")]: {
  ...
  [phraseKey("odvtedy", "відтоді", "b1-28")]: {
  ...
  [phraseKey("dovtedy", "до того времени", "b1-28")]: {
  ...
  // =========================
  [phraseKey("nepríjemné", "неприємно", "b1-29")]: {
  ...
  [phraseKey("uraziť", "образити", "b1-29")]: {
  ...
  [phraseKey("kritizovať", "критикувати", "b1-29")]: {
  ...
  [phraseKey("vyjadriť sa", "висловитися", "b1-29")]: {
  ...
  [phraseKey("vysvetlenie", "пояснення", "b1-29")]: {
  ...
  [phraseKey("ospravedlnenie", "вибачення", "b1-29")]: {
  ...
  [phraseKey("pochopiť", "зрозуміти", "b1-29")]: {
  ...
  [phraseKey("zachovať pokoj", "зберігати спокій", "b1-29")]: {
  ...
  [phraseKey("ustúpiť", "поступитися", "b1-29")]: {
  ...
  [phraseKey("urovnať", "уладнати", "b1-29")]: {
  ...
  // =========================
  [phraseKey("ak tomu rozumiem správne", "якщо я правильно розумію", "b1-30")]: {
  ...
  [phraseKey("inými slovami", "іншими словами", "b1-30")]: {
  ...
  [phraseKey("na druhej strane", "з іншого боку", "b1-30")]: {
  ...
  [phraseKey("v každom prípade", "в будь-якому разі", "b1-30")]: {
  ...
  [phraseKey("neviem presne", "не знаю точно", "b1-30")]: {
  ...
  [phraseKey("to dáva zmysel", "це має сенс", "b1-30")]: {
  ...
  [phraseKey("to je zaujímavé", "це цікаво", "b1-30")]: {
  ...
  [phraseKey("poďme ďalej", "йдемо далі", "b1-30")]: {
