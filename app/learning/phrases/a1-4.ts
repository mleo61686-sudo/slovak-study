...
export const A1_PHRASES_4: Record<string, Phrase> = {
  ...
  [phraseKey("zavesiť", "a1-33")]: {
    ...
    en: "I will hang a picture on the wall.",
  ...
  [phraseKey("zariadiť", "a1-33")]: {
    ...
    en: "I want to furnish my apartment.",
  ...
  [phraseKey("reklamovať", "a1-38")]: {
    ...
    en: "I want to complain about this item.",
