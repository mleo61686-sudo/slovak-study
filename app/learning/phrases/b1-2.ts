...
export const B1_PHRASES_2: Record<string, Phrase> = {
  ...
  [phraseKey("sucho", "b1-11")]: {
    ...
    en: "This year there is a severe drought and the harvest is weaker.",
  ...
  [phraseKey("klíma", "b1-11")]: {
    ...
    en: "The climate is changing, which is why extreme events are becoming more frequent.",
  ...
  [phraseKey("lavína", "b1-11")]: {
    ...
    en: "There is an avalanche risk in the mountains, so we are not going off the route.",
  ...
  [phraseKey("vlhkosť", "b1-11")]: {
    ...
    en: "Humidity is high today, so it is hard for me to breathe.",
  ...
  [phraseKey("topenie", "b1-11")]: {
    ...
    en: "Melting snow can cause a rise in water levels.",
  ...
  [phraseKey("prechodný pobyt", "b1-12")]: {
    ...
    en: "I arranged my temporary residence permit at the foreign police office.",
  ...
  [phraseKey("vyhlásenie", "b1-12")]: {
    ...
    en: "I have to sign a declaration that the information is true.",
  ...
  [phraseKey("občianstvo", "b1-12")]: {
    ...
    en: "You can apply for citizenship only after meeting the conditions.",
  ...
  [phraseKey("oprávnenie", "b1-12")]: {
    ...
    en: "The official is authorized to verify your documents.",
  ...
  [phraseKey("ochota", "b1-13")]: {
    ...
    en: "I appreciate your willingness to help; it made the situation much easier for me.",
  ...
  [phraseKey("zákazník", "b1-13")]: {
    ...
    en: "A customer has the right to clear information about the service.",
  ...
  [phraseKey("nespokojný", "b1-13")]: {
    ...
    en: "He was dissatisfied because the response came too late.",
  ...
  [phraseKey("zodpovedať za", "b1-13")]: {
    ...
    en: "Each of us is responsible for our part of the work.",
  ...
  [phraseKey("vyhovieť", "b1-13")]: {
    ...
    en: "We will try to accommodate you if it is possible.",
  ...
  [phraseKey("podpora zákazníkov", "b1-13")]: {
    ...
    en: "Customer support is also available through chat.",
  ...
  [phraseKey("požiadavka", "b1-13")]: {
    ...
    en: "Please send us your request by email.",
  ...
  [phraseKey("zloženie", "b1-14")]: {
    ...
    en: "I always read the ingredients, especially on ready-made meals.",
  ...
  [phraseKey("porcia", "b1-14")]: {
    ...
    en: "This portion is too large for me.",
  ...
  [phraseKey("obmedziť", "b1-14")]: {
    ...
    en: "I want to limit sweets because I do not feel well.",
  ...
  [phraseKey("vyvážená strava", "b1-14")]: {
    ...
    en: "A balanced diet should include both protein and vegetables.",
  ...
  [phraseKey("pravidelnosť", "b1-14")]: {
    ...
    en: "Regularity is important, whether in eating or sleeping.",
  ...
  [phraseKey("výdrž", "b1-15")]: {
    ...
    en: "I need better endurance for a long run.",
  ...
  [phraseKey("rozohriatie", "b1-15")]: {
    ...
    en: "Warming up before exercise is very important.",
  ...
  [phraseKey("strečing", "b1-15")]: {
    ...
    en: "After training, I do a short stretching session.",
  ...
  [phraseKey("životospráva", "b1-15")]: {
    ...
    en: "A good lifestyle also shows in your mood.",
  ...
  [phraseKey("kondícia", "b1-15")]: {
    ...
    en: "My fitness is better than last month.",
  ...
  [phraseKey("zlepšiť výkon", "b1-15")]: {
    ...
    en: "If I want to improve my performance, I must train regularly.",
  ...
  [phraseKey("vkus", "b1-16")]: {
    ...
    en: "We have different tastes, but we can agree.",
  ...
  [phraseKey("recenzia", "b1-16")]: {
    ...
    en: "I read the review and then decided to go to the cinema.",
  ...
  [phraseKey("voľný čas", "b1-16")]: {
    ...
    en: "I most like to spend my free time with family or in nature.",
  ...
  [phraseKey("navštíviť", "b1-16")]: {
    ...
    en: "I want to visit the exhibition while it is still running.",
  ...
  [phraseKey("program podujatia", "b1-16")]: {
    ...
    en: "You can find the event program on the organizer’s website.",
  ...
  [phraseKey("rezervácia miesta", "b1-16")]: {
    ...
    en: "Seat reservation is necessary because capacity is limited.",
  ...
  [phraseKey("tréning", "b1-17")]: {
    ...
    en: "I have training this evening, so I will come home later.",
  ...
  [phraseKey("výhra", "b1-17")]: {
    ...
    en: "The win gave us confidence for the next matches.",
  ...
  [phraseKey("prehra", "b1-17")]: {
    ...
    en: "The loss was unpleasant, but we learned from it.",
  ...
  [phraseKey("súťaž", "b1-17")]: {
    ...
    en: "We have been preparing for the competition for several weeks.",
  ...
  [phraseKey("tím", "b1-17")]: {
    ...
    en: "The team works better when we trust each other.",
  ...
  [phraseKey("obyvateľstvo", "b1-18")]: {
    ...
    en: "The city’s population has increased in recent years.",
  ...
  [phraseKey("povrch", "b1-18")]: {
    ...
    en: "The terrain of this area is mostly mountainous.",
  ...
  [phraseKey("ostrov", "b1-18")]: {
    ...
    en: "The island can only be reached by boat or plane.",
  ...
  [phraseKey("zemepis", "b1-18")]: {
    ...
    en: "I enjoy geography because I learn a lot about countries.",
  ...
  [phraseKey("výsledok", "b1-19")]: {
    ...
    en: "I got a different result, so I recalculated it once again.",
  ...
  [phraseKey("deliť", "b1-19")]: {
    ...
    en: "If you want to divide fractions, you must follow the procedure.",
  ...
  [phraseKey("zlomok", "b1-19")]: {
    ...
    en: "A fraction can be simplified when you divide both the numerator and the denominator.",
  ...
  [phraseKey("percento", "b1-19")]: {
    ...
    en: "What percentage of the price is the discount?",
  ...
  [phraseKey("graf", "b1-19")]: {
    ...
    en: "The graph shows that sales rise in summer.",
  ...
  [phraseKey("vypočítať", "b1-19")]: {
    ...
    en: "Can you calculate how much it will be in total?",
  ...
  [phraseKey("zákon", "b1-20")]: {
    ...
    en: "The law applies equally to everyone.",
  ...
  [phraseKey("vláda", "b1-20")]: {
    ...
    en: "The government introduced a new plan to support families.",
  ...
  [phraseKey("občan", "b1-20")]: {
    ...
    en: "As a citizen, I have rights but also duties.",
  ...
  [phraseKey("referendum", "b1-20")]: {
    ...
    en: "Important issues are sometimes decided by referendum.",
  ...
  [phraseKey("štátna správa", "b1-20")]: {
    ...
    en: "Public administration should function efficiently and transparently.",
