...
export const CS_A2_PHRASES_4: Record<string, Phrase> = {
  ...
  [phraseKey("nabídka", "a2-31")]: {
    ...
    en: "That apartment offer looks interesting.",
  ...
  [phraseKey("poptávka", "a2-31")]: {
    ...
    en: "There is high demand for apartments in the city center.",
  ...
  [phraseKey("prohlídka", "a2-31")]: {
    ...
    en: "We have an apartment viewing tomorrow.",
  ...
  [phraseKey("záloha", "a2-31")]: {
    ...
    en: "The owner requires an advance payment upfront.",
  ...
  [phraseKey("kauce", "a2-31")]: {
    ...
    en: "The deposit is equal to one month's rent.",
  ...
  [phraseKey("energie v ceně", "a2-31")]: {
    ...
    en: "The ad said utilities were included in the price.",
  ...
  [phraseKey("nezařízený", "a2-31")]: {
    ...
    en: "That apartment is completely unfurnished.",
  ...
  [phraseKey("spolubydlení", "a2-31")]: {
    ...
    en: "Shared housing is cheaper than having your own apartment.",
  ...
  [phraseKey("schopnost", "a2-32")]: {
    ...
    en: "Communication is an important ability.",
  ...
  [phraseKey("samostatný", "a2-32")]: {
    ...
    en: "In this position you have to be independent.",
  ...
  [phraseKey("učit se rychle", "a2-32")]: {
    ...
    en: "You have to be able to learn quickly.",
  ...
  [phraseKey("volný čas", "a2-33")]: {
    ...
    en: "I like reading in my free time.",
  ...
  [phraseKey("odpočinout si", "a2-33")]: {
    ...
    en: "At the weekend I finally want to rest.",
  ...
  [phraseKey("událost", "a2-33")]: {
    ...
    en: "That is an important cultural event.",
  ...
  [phraseKey("představení", "a2-33")]: {
    ...
    en: "That theatre performance was great.",
  ...
  [phraseKey("servis", "a2-34")]: {
    ...
    en: "The car is in the service shop now.",
  ...
  [phraseKey("diagnostika", "a2-34")]: {
    ...
    en: "First they will do the car diagnostics.",
  ...
  [phraseKey("ceník", "a2-34")]: {
    ...
    en: "They have the price list posted at the entrance.",
  ...
  [phraseKey("schválit", "a2-34")]: {
    ...
    en: "You have to approve the repair first.",
  ...
  [phraseKey("dostupnost", "a2-35")]: {
    ...
    en: "First I need to check the availability of the goods.",
  ...
  [phraseKey("vyprodáno", "a2-35")]: {
    ...
    en: "They still had it yesterday, but today it is sold out.",
  ...
  [phraseKey("vyměnit zboží", "a2-35")]: {
    ...
    en: "I want to exchange the goods for a different one.",
  ...
  [phraseKey("recepce", "a2-36")]: {
    ...
    en: "At the reception they gave us the room card.",
  ...
  [phraseKey("odhlásit se", "a2-36")]: {
    ...
    en: "We have to check out by ten o'clock.",
  ...
  [phraseKey("předkrm", "a2-37")]: {
    ...
    en: "As a starter, I will have soup.",
  ...
  [phraseKey("hlavní jídlo", "a2-37")]: {
    ...
    en: "The main course was really excellent.",
  ...
  [phraseKey("bez masa", "a2-37")]: {
    ...
    en: "Do you have anything good without meat?",
  ...
  [phraseKey("upřesnit", "a2-38")]: {
    ...
    en: "I still need to clarify the meeting time.",
  ...
  [phraseKey("dohodnout termín", "a2-38")]: {
    ...
    en: "We still need to arrange the date of the meeting.",
  ...
  [phraseKey("příloha", "a2-38")]: {
    ...
    en: "The email was missing the attachment.",
  ...
  [phraseKey("zopakovat", "a2-39")]: {
    ...
    en: "Could you please repeat it once more?",
  ...
  [phraseKey("kauce", "a2-40")]: {
    ...
    en: "Without a deposit, we will not get that apartment.",
  ...
  [phraseKey("odhlásit se", "a2-40")]: {
    ...
    en: "We have to check out of the hotel early in the morning.",
  ...
  [phraseKey("příloha", "a2-40")]: {
    ...
    en: "I am sending the required documents in the attachment.",
