...
export const CS_A2_PHRASES_1: Record<string, Phrase> = {
  ...
  [phraseKey("nájemní smlouva", "договір оренди", "a2-1")]: {
  ...
  [phraseKey("majitel", "власник", "a2-1")]: {
  ...
  [phraseKey("podnájemník", "орендар", "a2-1")]: {
  ...
  [phraseKey("stěhování", "переїзд", "a2-1")]: {
  ...
  // =========================
  [phraseKey("vyšetření", "обстеження", "a2-2")]: {
  ...
  [phraseKey("příznak", "симптом", "a2-2")]: {
  ...
  [phraseKey("bolest v krku", "біль у горлі", "a2-2")]: {
  ...
  [phraseKey("teploměr", "термометр", "a2-2")]: {
  ...
  [phraseKey("krvní tlak", "артеріальний тиск", "a2-2")]: {
  ...
  [phraseKey("alergie", "алергія", "a2-2")]: {
  ...
  [phraseKey("zánět", "запалення", "a2-2")]: {
  ...
  [phraseKey("doporučení", "рекомендація", "a2-2")]: {
  ...
  // =========================
  [phraseKey("městský úřad", "міська рада/мерія", "a2-3")]: {
  ...
  [phraseKey("oddělení", "відділення/відділ", "a2-3")]: {
  ...
  [phraseKey("žadatel", "заявник", "a2-3")]: {
  ...
  [phraseKey("potvrzení", "підтвердження/довідка", "a2-3")]: {
  ...
  [phraseKey("poplatek", "збір/плата", "a2-3")]: {
  ...
  [phraseKey("objednat se", "записатися (на прийом)", "a2-3")]: {
  ...
  [phraseKey("otevírací hodiny", "години роботи", "a2-3")]: {
  ...
  [phraseKey("formulář", "бланк/форма", "a2-3")]: {
  ...
  [phraseKey("praxe", "досвід роботи/практика", "a2-4")]: {
  ...
  [phraseKey("zručnost", "навичка", "a2-4")]: {
  ...
  [phraseKey("požadavek", "вимога", "a2-4")]: {
  ...
  [phraseKey("pracovní nabídka", "вакансія", "a2-4")]: {
  ...
  [phraseKey("pracovní pozice", "посада", "a2-4")]: {
  ...
  [phraseKey("odpovědnost", "відповідальність", "a2-4")]: {
  ...
  [phraseKey("zkoušební doba", "випробувальний термін", "a2-4")]: {
  ...
  // =========================
  [phraseKey("rezervace", "бронювання", "a2-5")]: {
  ...
  [phraseKey("ubytování", "проживання", "a2-5")]: {
  ...
  [phraseKey("potvrdit", "підтвердити", "a2-5")]: {
  ...
  [phraseKey("zrušit", "скасувати", "a2-5")]: {
  ...
  [phraseKey("zpoždění", "затримка", "a2-5")]: {
  ...
  [phraseKey("přesun", "переміщення/трансфер", "a2-5")]: {
  ...
  [phraseKey("jednosměrný", "в один бік", "a2-5")]: {
  ...
  [phraseKey("zpáteční", "туди-й-назад", "a2-5")]: {
  ...
  [phraseKey("cestovní pojištění", "туристична страховка", "a2-5")]: {
  ...
  [phraseKey("zavazadlo", "багаж", "a2-5")]: {
  ...
  [phraseKey("ušetřit", "заощадити", "a2-6")]: {
  ...
  [phraseKey("minout", "витратити", "a2-6")]: {
  ...
  [phraseKey("bankovní účet", "банківський рахунок", "a2-6")]: {
  ...
  [phraseKey("trvalý příkaz", "постійне доручення (автоплатіж)", "a2-6")]: {
  ...
  [phraseKey("poplatek", "комісія/збір", "a2-6")]: {
  ...
  // =========================
  [phraseKey("podle mě", "на мою думку", "a2-7")]: {
  ...
  [phraseKey("zdá se mi", "мені здається", "a2-7")]: {
  ...
  [phraseKey("navrhnout", "запропонувати", "a2-7")]: {
  ...
  [phraseKey("shrnout", "підсумувати", "a2-7")]: {
  ...
  [phraseKey("vyjádřit názor", "висловити думку", "a2-7")]: {
  ...
  [phraseKey("argumentovat", "аргументувати", "a2-7")]: {
  ...
  [phraseKey("přesvědčit", "переконати", "a2-7")]: {
  ...
  [phraseKey("reagovat", "реагувати", "a2-7")]: {
  ...
  // =========================
  [phraseKey("posunout", "перенести (дату/зустріч)", "a2-8")]: {
  ...
  [phraseKey("naplánovat", "запланувати", "a2-8")]: {
  ...
  [phraseKey("odložit", "відкласти", "a2-8")]: {
  ...
  [phraseKey("zúčastnit se", "взяти участь", "a2-8")]: {
  ...
  [phraseKey("změnit plán", "змінити план", "a2-8")]: {
  ...
  [phraseKey("konat se", "відбуватися", "a2-8")]: {
  ...
  [phraseKey("organizovat", "організувати", "a2-8")]: {
  ...
  [phraseKey("uskutečnit se", "відбутися", "a2-8")]: {
  ...
  [phraseKey("zpozdit se", "запізнюватися", "a2-8")]: {
  ...
  [phraseKey("stihnout", "встигнути", "a2-8")]: {
  ...
  [phraseKey("stížnost", "скарга", "a2-9")]: {
  ...
  [phraseKey("peníze zpět", "гроші назад", "a2-9")]: {
  ...
  [phraseKey("vrácení zboží", "повернення товару", "a2-9")]: {
  ...
  [phraseKey("pokladní blok", "касовий чек", "a2-9")]: {
  ...
  [phraseKey("reklamovat", "подати рекламацію", "a2-9")]: {
  ...
  // =========================
  [phraseKey("předpověď", "прогноз", "a2-10")]: {
  ...
  [phraseKey("přeháňka", "злива/короткий дощ", "a2-10")]: {
  ...
  [phraseKey("náledí", "ожеледиця", "a2-10")]: {
  ...
  [phraseKey("vlhkost", "вологість", "a2-10")]: {
  ...
  [phraseKey("ochladit se", "похолоднішати", "a2-10")]: {
  ...
  [phraseKey("oteplit se", "потеплішати", "a2-10")]: {
  ...
  [phraseKey("prudký vítr", "сильний вітер", "a2-10")]: {
