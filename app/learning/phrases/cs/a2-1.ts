...
export const CS_A2_PHRASES_1: Record<string, Phrase> = {
  ...
  [phraseKey("nájemní smlouva", "a2-1")]: {
    ...
    en: "I still need to read the rental agreement.",
  ...
  [phraseKey("energie", "a2-1")]: {
    ...
    en: "Energy prices are higher this year.",
  ...
  [phraseKey("diagnóza", "a2-2")]: {
    ...
    en: "We are still waiting for an exact diagnosis.",
  ...
  [phraseKey("bolest v krku", "a2-2")]: {
    ...
    en: "I have had a sore throat since morning.",
  ...
  [phraseKey("zánět", "a2-2")]: {
    ...
    en: "It turned out to be an inflammation.",
  ...
  [phraseKey("doporučení", "a2-2")]: {
    ...
    en: "I got a referral to a specialist.",
  ...
  [phraseKey("žádost", "a2-3")]: {
    ...
    en: "You can submit the application online.",
  ...
  [phraseKey("doklad", "a2-3")]: {
    ...
    en: "It will not work without an ID.",
  ...
  [phraseKey("pracovní nabídka", "a2-4")]: {
    ...
    en: "That job offer looks interesting.",
  ...
  [phraseKey("pracovní pozice", "a2-4")]: {
    ...
    en: "Which job position are you interested in?",
  ...
  [phraseKey("odpovědnost", "a2-4")]: {
    ...
    en: "This job requires great responsibility.",
  ...
  [phraseKey("přesun", "a2-5")]: {
    ...
    en: "The transfer to the hotel will be arranged by the driver.",
  ...
  [phraseKey("rozpočet", "a2-6")]: {
    ...
    en: "This month we need to keep an eye on the budget.",
  ...
  [phraseKey("reagovat", "a2-7")]: {
    ...
    en: "We have to react more quickly.",
  ...
  [phraseKey("uskutečnit se", "a2-8")]: {
    ...
    en: "The meeting eventually took place.",
  ...
  [phraseKey("stihnout", "a2-8")]: {
    ...
    en: "I hope I will still make it in time.",
  ...
  [phraseKey("pokladní blok", "a2-9")]: {
    ...
    en: "It will not work without a receipt.",
  ...
  [phraseKey("doklad", "a2-9")]: {
    ...
    en: "Do you have any document for that?",
  ...
  [phraseKey("polooblačno", "a2-10")]: {
    ...
    en: "It is supposed to be partly cloudy in the afternoon.",
  ...
  [phraseKey("přeháňka", "a2-10")]: {
    ...
    en: "There may be a shower in the evening.",
  ...
  [phraseKey("jasno", "a2-10")]: {
    ...
    en: "It was completely clear in the morning.",
  ...
  [phraseKey("ochladit se", "a2-10")]: {
    ...
    en: "It is supposed to get noticeably colder in the evening.",
  ...
  [phraseKey("oteplit se", "a2-10")]: {
    ...
    en: "It will get warmer again at the weekend.",
