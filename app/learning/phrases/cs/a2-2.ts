...
export const CS_A2_PHRASES_2: Record<string, Phrase> = {
  ...
  [phraseKey("zdravé jídlo", "здорова їжа", "a2-11")]: {
  ...
  [phraseKey("nezdravý", "нездоровий", "a2-11")]: {
  ...
  [phraseKey("kalorie", "калорії", "a2-11")]: {
  ...
  [phraseKey("bílkoviny", "білки", "a2-11")]: {
  ...
  [phraseKey("hydratace", "гідратація", "a2-11")]: {
  ...
  // =========================
  [phraseKey("trénink", "тренування", "a2-12")]: {
  ...
  [phraseKey("cvičit", "тренуватися", "a2-12")]: {
  ...
  [phraseKey("posilovna", "спортзал", "a2-12")]: {
  ...
  [phraseKey("vytrvalost", "витривалість", "a2-12")]: {
  ...
  [phraseKey("zahřát se", "розігрітися", "a2-12")]: {
  ...
  [phraseKey("protáhnout se", "розтягнутися", "a2-12")]: {
  ...
  [phraseKey("zranění", "травма", "a2-12")]: {
  ...
  [phraseKey("regenerace", "відновлення", "a2-12")]: {
  ...
  // =========================
  [phraseKey("vztah", "стосунки", "a2-13")]: {
  ...
  [phraseKey("respekt", "повага", "a2-13")]: {
  ...
  [phraseKey("hádat se", "сваритися", "a2-13")]: {
  ...
  [phraseKey("smířit se", "помиритися", "a2-13")]: {
  ...
  [phraseKey("trpělivost", "терпіння", "a2-13")]: {
  ...
  [phraseKey("doručení", "доставка", "a2-14")]: {
  ...
  [phraseKey("sledování zásilky", "відстеження посилки", "a2-14")]: {
  ...
  [phraseKey("doručovací adresa", "адреса доставки", "a2-14")]: {
  ...
  [phraseKey("vrácení", "повернення", "a2-14")]: {
  ...
  // =========================
  [phraseKey("nastavit", "налаштувати", "a2-15")]: {
  ...
  [phraseKey("aktualizace", "оновлення", "a2-15")]: {
  ...
  [phraseKey("připojení", "підключення", "a2-15")]: {
  ...
  [phraseKey("výpadek", "збій/відключення", "a2-15")]: {
  ...
  [phraseKey("zaseknout se", "зависнути", "a2-15")]: {
  ...
  [phraseKey("restartovat", "перезавантажити", "a2-15")]: {
  ...
  [phraseKey("nainstalovat", "встановити", "a2-15")]: {
  ...
  [phraseKey("vymazat", "видалити", "a2-15")]: {
  ...
  [phraseKey("obnovit", "відновити", "a2-15")]: {
  ...
  [phraseKey("přednáška", "лекція", "a2-16")]: {
  ...
  [phraseKey("domácí úkol", "домашнє завдання", "a2-16")]: {
  ...
  [phraseKey("zručnost", "навичка", "a2-16")]: {
  ...
  [phraseKey("zlepšit se", "покращитися", "a2-16")]: {
  ...
  [phraseKey("opakovat", "повторювати", "a2-16")]: {
  ...
  [phraseKey("učit se nazpaměť", "вчити напам’ять", "a2-16")]: {
  ...
  // =========================
  [phraseKey("rozdělit úkoly", "розподілити завдання", "a2-17")]: {
  ...
  [phraseKey("spolupracovat", "співпрацювати", "a2-17")]: {
  ...
  [phraseKey("zodpovídat", "відповідати (бути відповідальним)", "a2-17")]: {
  ...
  [phraseKey("odvzdat", "здати/передати", "a2-17")]: {
  ...
  [phraseKey("zkontrolovat", "перевірити", "a2-17")]: {
  ...
  [phraseKey("organizovat", "організовувати", "a2-17")]: {
  ...
  [phraseKey("zpětná vazba", "зворотний зв’язок", "a2-17")]: {
  ...
  [phraseKey("navrhnout řešení", "запропонувати рішення", "a2-17")]: {
  ...
  [phraseKey("dokončit", "завершити", "a2-17")]: {
  ...
  // =========================
  [phraseKey("založit účet", "відкрити рахунок", "a2-18")]: {
  ...
  [phraseKey("výběr", "зняття (грошей)", "a2-18")]: {
  ...
  [phraseKey("převést", "перевести (гроші)", "a2-18")]: {
  ...
  [phraseKey("platební karta", "платіжна картка", "a2-18")]: {
  ...
  [phraseKey("poplatek", "комісія", "a2-18")]: {
  ...
  [phraseKey("zablokovat kartu", "заблокувати картку", "a2-18")]: {
  ...
  // =========================
  [phraseKey("povolení", "дозвіл", "a2-19")]: {
  ...
  [phraseKey("občanský průkaz", "ID-картка", "a2-19")]: {
  ...
  [phraseKey("registrace", "реєстрація", "a2-19")]: {
  ...
  [phraseKey("fotografie", "фото", "a2-19")]: {
  ...
  [phraseKey("ověřit", "завірити/підтвердити", "a2-19")]: {
  ...
  [phraseKey("termín schůzky", "дата прийому", "a2-19")]: {
  ...
  [phraseKey("vyřídit", "оформити/вирішити (справу)", "a2-19")]: {
  ...
  [phraseKey("trénink", "тренування", "a2-20")]: {
  ...
  [phraseKey("doručení", "доставка", "a2-20")]: {
  ...
  [phraseKey("aktualizace", "оновлення", "a2-20")]: {
  ...
  [phraseKey("přednáška", "лекція", "a2-20")]: {
  ...
  [phraseKey("zpětná vazba", "зворотний зв’язок", "a2-20")]: {
  ...
  [phraseKey("povolení", "дозвіл", "a2-20")]: {
  ...
  [phraseKey("vyřídit", "оформити/вирішити", "a2-20")]: {
