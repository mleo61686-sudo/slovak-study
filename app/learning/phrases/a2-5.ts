...
export const A2_PHRASES_5: Record<string, Phrase> = {
  ...
  [phraseKey("ambícia", "a2-41")]: {
    ...
    en: "My ambition is to improve at work.",
  ...
  [phraseKey("zvážiť", "a2-41")]: {
    ...
    en: "I have to consider all options.",
  ...
  [phraseKey("vytrvať", "a2-41")]: {
    ...
    en: "You must persevere and not give up.",
  ...
  [phraseKey("smer", "a2-42")]: {
    ...
    en: "Which direction is the station?",
  ...
  [phraseKey("povolené", "a2-42")]: {
    ...
    en: "It is allowed to turn left here.",
  ...
  [phraseKey("obchádzka", "a2-42")]: {
    ...
    en: "The road is closed, there is a detour.",
  ...
  [phraseKey("nasledovať", "a2-42")]: {
    ...
    en: "Follow this street to the bridge.",
  ...
  [phraseKey("orientovať sa", "a2-42")]: {
    ...
    en: "I cannot orient myself well here.",
  ...
  [phraseKey("zvyknúť si", "a2-43")]: {
    ...
    en: "I had to get used to a new routine.",
  ...
  [phraseKey("odvyknúť si", "a2-43")]: {
    ...
    en: "I want to stop eating sweets.",
  ...
  [phraseKey("zdvorilý", "a2-44")]: {
    ...
    en: "He was very polite to customers.",
  ...
  [phraseKey("ochotný", "a2-44")]: {
    ...
    ua: "Персонал bol готовий допомогти.",
    ru: "Персонал был готов помочь.",
    en: "The staff was willing to help.",
  ...
  [phraseKey("poradiť si", "a2-45")]: {
    ...
    en: "I have to deal with it somehow.",
  ...
  [phraseKey("pokus", "a2-45")]: {
    ...
    en: "We will give it another try.",
  ...
  [phraseKey("istota", "a2-46")]: {
    ...
    en: "I need certainty that it is correct.",
  ...
  [phraseKey("zistiť", "a2-46")]: {
    ...
    ua: "Мені treba з’ясувати, що сталося.",
  ...
  [phraseKey("názor", "a2-47")]: {
    ...
    en: "My opinion is a bit different.",
  ...
  [phraseKey("reklama", "a2-47")]: {
    ...
    en: "That advertisement annoys me.",
  ...
  [phraseKey("tábor", "a2-48")]: {
    ...
    en: "We will set up camp near the forest.",
  ...
  [phraseKey("výbava", "a2-48")]: {
    ...
    en: "Do not forget to take your equipment.",
  ...
  [phraseKey("silný vietor", "a2-49")]: {
    ...
    ua: "Сьогодні bude сильний вітер.",
    ru: "Сегодня будет сильный ветер.",
    en: "There will be strong wind today.",
  ...
  [phraseKey("vlna horúčav", "a2-49")]: {
    ...
    en: "A heatwave is coming, drink more water.",
  ...
  [phraseKey("ochladenie", "a2-49")]: {
    ...
    en: "Cooling will come in the evening.",
  ...
  [phraseKey("dosiahnuť", "a2-50")]: {
    ...
    en: "If you want to achieve your goal, you must work regularly.",
  ...
  [phraseKey("obchádzka", "a2-50")]: {
    ...
    en: "There is a detour due to an accident.",
  ...
  [phraseKey("poradiť si", "a2-50")]: {
    ...
    ua: "Я дам собі radu, навіть якщо буде важко.",
  ...
  [phraseKey("zdroj", "a2-50")]: {
    ...
    en: "Let us verify the source to be sure.",
  ...
  [phraseKey("výbava", "a2-50")]: {
    ...
    en: "Without proper equipment, hiking is risky.",
  ...
  [phraseKey("orientovať sa", "a2-50")]: {
    ...
    en: "With a map, I will orient myself more easily.",
