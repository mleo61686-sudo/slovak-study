...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Learn Slovak Language Online | Flunio",
    description:
...
const FAQ = [
  {
    ...
    a: "Yes. Flunio offers free lessons with exercises, pronunciation and progress tracking.",
  },
  {
    ...
    <main className="mx-auto max-w-4xl px-4 py-10 space-y-10">
      ...
      <section className="space-y-3">
        ...
        <p className="text-slate-700">
          Flunio is an online platform where you can learn Slovak language
