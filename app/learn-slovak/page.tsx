  ...
  return (
    <main className="mx-auto max-w-4xl space-y-10 px-4 py-10 text-white">
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        {[
          ["1) Slovak lessons by level", "Lessons are organized from A0 to B2, so you always know what to learn next. This helps you avoid chaos and build Slovak vocabulary and grammar in a logical order."],
          ...
          ["3) Audio pronunciation", "Slovak pronunciation becomes easier when you hear words often. Audio helps you recognize sounds and improve your listening skills."],
